...
#| fig-align: center
plot(date$zi, date$sus, type = "l", col = "red", lwd = 2,
     main = "Evolutia zilnica a cererilor sus si detectate,ver. simpla",
     xlab = "Ziua",
     ylab = "Nr. cereri",
     ylim = c(0, max(date$sus))
     )
...
#| fig-align: center
plot(date$zi, date$sus, type = "l", col = "red", lwd = 2,
     main = "Evolutia zilnica a cererilor sus si detectate,ver. adaptiva 3",
     xlab = "Ziua",
     ylab = "Nr. cereri",
     ylim = c(0, max(date$sus))
     )
...
##TO:DO CA NU MAI AM CHEF.
## EXPLICATI CUM SE GENEREAZA TABELUL ASTA TOTU E IN CODU DE program1.r la functia calc_auto. Adica ce inseamna acel skewness (Pearson stuff din sursa), restul is cam ez de explicat.
